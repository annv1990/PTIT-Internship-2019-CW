...
public class Constant {
    ...
    public static final String F_TEMP = "°F";
    public static final String C_TEMP = "°C";
    ...
    public static final String KEY_MOVIE_DURATION = "key_movie_duration";
    ...
    public static final String KEY_WEATHER_LIST = "weatherList";
